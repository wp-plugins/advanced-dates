...
Please note the plugin will not take effect, even after activation, until a publisher chooses one of the two options in the Settings > Advanced Dates admin screen.
...
Future Build: (a) integrate "creative" date framework for sci-fi and speculative fiction and (b) other create-your-own calendar and date systems.
