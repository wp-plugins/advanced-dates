<?php  
    ...
    Description: Extending the literary, documentary, and archival potential of WordPress, this plugin allows publishers to easily customize the publication year of posts and pages. (To customize the plugin, visit <a href="options-general.php?page=advanced_dates.php">Settings > Advanced Dates</a>.) <em>w/ special thanks to <a href="http://www.ryanajarrett.com">Ryan Jarrett</a></em>
	Version: 1.0 
    ...
    */  
	...
	if ($file == $this_plugin){
	$settings_link = '<a href="options-general.php?page=advanced_dates.php">'.__("Settings", "advanced_dates").'</a>';
